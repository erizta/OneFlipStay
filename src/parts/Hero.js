      ...
      <div className="row align-items-center">
        <div className="col-auto pr-5" style={{ width: 530 }}>
          ...
          >
            ...
            your holiday with the finest homes
        ...
        <div className="col-6 pl-5">
          <div style={{ width: 520, height: 410 }}>
            <img src={ImageHero} alt="Modern room" className="img-fluid position-absolute" style={{ margin: '-30px 0 0 -30px', zIndex: 1 }} />
            <img src={ImageHero_} alt="Modern room frame" className="img-fluid position-absolute" style={{ margin: '0 -15px -15px 0' }} />
