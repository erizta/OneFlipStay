            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-3">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button isExternal type="link" href="mailto:support@oneflipstay.id">support@oneflipstay.id</Button>
                            </li>
                            <li className="list-group-item">
                                <Button isExternal type="link" href="tel:+622122081996">021 - 2208 - 1996</Button>
                            </li>
                            <li className="list-group-item">
                                <span>OneFLipStay, Demangan, Yogyakarta</span>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="row">
                    <div className="col text-center copyrights">
                        Copyrights 2021 - All rights reserved - OneFlipStay
                    </div>
                </div>
            </div>
        </footer>
